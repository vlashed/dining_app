...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { area_id: @table.area_id, capacity: @table.capacity, height: @table.height, length: @table.length, name: @table.name }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { area_id: @table.area_id, capacity: @table.capacity, height: @table.height, length: @table.length, name: @table.name }
    assert_redirected_to table_path(assigns(:table))
  end
